...
abstract class FlutterSteamworksPlatform extends PlatformInterface {
  ...
  Future<bool> requestCurrentStats() {
    throw UnimplementedError('requestCurrentStats() has not been implemented.');
  }

  Future<bool> getAchievement(String achievementId) {
    throw UnimplementedError('getAchievement() has not been implemented.');
  }

  Future<bool> setAchievement(String achievementId) {
    throw UnimplementedError('setAchievement() has not been implemented.');
  }

  Future<bool> clearAchievement(String achievementId) {
    throw UnimplementedError('clearAchievement() has not been implemented.');
  }

  Future<bool> storeStats() {
    throw UnimplementedError('storeStats() has not been implemented.');
  }
}
