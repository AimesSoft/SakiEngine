...
class ReadTextSkipManager {
  ...
  void _performSkipStep() {
    ...
    if (currentState.dialogue != null && currentState.dialogue!.isNotEmpty) {
      final isCurrentRead = readTextTracker.isRead(currentState.speaker,
          currentState.dialogue!, gameManager.currentScriptIndex);
  ...
  bool shouldAutoSkip() {
    ...
    return readTextTracker.isRead(currentState.speaker, currentState.dialogue!,
        gameManager.currentScriptIndex);
  }
